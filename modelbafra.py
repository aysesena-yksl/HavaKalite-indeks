...
Original file is located at
    https://colab.research.google.com/drive/1pCttYwLF-PEcTvnkzqjbqjNKTNFTMtPy
"""
...
import pandas as pd
import numpy as np
data = pd.read_excel(io.BytesIO(uploaded['YETER.xlsx']))
...
model.fit(x_train, y_train, batch_size=1, epochs=120)         #modeli eğit
...
plt.ylabel('katıatık', fontsize=20)
